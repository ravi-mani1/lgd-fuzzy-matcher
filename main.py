...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--subdistrict-csv", default=None, help="Sub-district master CSV (optional)")
    p.add_argument("--village-csv", default=None, help="Village master CSV (optional)")
...
def main() -> None:
    ...
    if args.use_mysql:
        ...
        matcher.load_master_from_csv(
            args.state_csv, args.district_csv,
            subdistrict_csv=args.subdistrict_csv,
            village_csv=args.village_csv,
        )
